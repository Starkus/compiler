...
set CommonLinkerFlags=-opt:ref -incremental:no -dynamicbase:no
...
ml64 ..\out.asm /Zd /Zi /link kernel32.lib user32.lib Gdi32.lib winmm.lib /entry:Main /opt:ref /incremental:no /dynamicbase:no /subsystem:CONSOLE /debug
