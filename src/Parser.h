...
enum TokenType
{
	...
	TOKEN_KEYWORD_STRUCT	= 12,
	TOKEN_KEYWORD_UNION		= 13,
	TOKEN_KEYWORD_ENUM		= 14,
	TOKEN_KEYWORD_TYPE		= 15,
	TOKEN_KEYWORD_INLINE	= 16,
	TOKEN_KEYWORD_EXTERNAL	= 17,
	TOKEN_KEYWORD_INTRINSIC	= 18,
	TOKEN_KEYWORD_OPERATOR	= 19,
	TOKEN_KEYWORD_DEFER		= 20,
	TOKEN_KEYWORD_USING		= 21,
	TOKEN_KEYWORD_TYPEOF	= 22,
	TOKEN_KEYWORD_SIZEOF	= 23,
	TOKEN_KEYWORD_CAST		= 24,
	TOKEN_KEYWORD_End		= 24,
