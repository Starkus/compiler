...
enum TokenType : u8
{
	...
	TOKEN_KEYWORD_EXPORT	= 20,
	TOKEN_KEYWORD_CALLING_CONVENTION = 21,
	TOKEN_KEYWORD_INTRINSIC	= 22,
	TOKEN_KEYWORD_OPERATOR	= 23,
	TOKEN_KEYWORD_DEFER		= 24,
	TOKEN_KEYWORD_USING		= 25,
	TOKEN_KEYWORD_TYPEOF	= 26,
	TOKEN_KEYWORD_SIZEOF	= 27,
	TOKEN_KEYWORD_CAST		= 28,
	TOKEN_KEYWORD_INCLUDE	= 29,
	TOKEN_KEYWORD_LINKLIB	= 30,
	TOKEN_KEYWORD_IF_STATIC	= 31,
